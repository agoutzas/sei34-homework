...
const correctLength = function (creditCardNum){
...
const lastDigit = function (creditCardNum){
...
// The sum of all the digits must be greater than 16
  ...
  const sum = 0;
  for (var i = 0; 0 < creditCardNum.length; i++) {
...
for (var i = 0; i<creditCardNum.length; i++) {
  ...
  const currentNumber = creditCardNum[i];
  if (currentNumber=16) {
    return true
  }
